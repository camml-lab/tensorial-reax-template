...
class Qm9DataModule(reax.DataModule):
    ...
    QM9_STRUCTURES: Final[str] = "qe9_structures"

    data_train: Optional[list[jraph.GraphsTuple]] = None
    data_val: Optional[list[jraph.GraphsTuple]] = None
    data_test: Optional[list[jraph.GraphsTuple]] = None
